...
namespace Creshendo.Util
{
    ...
    public class LinkedHashMap : Hashtable
    {
    ...
    /// </summary>
    public class LinkedHashMap2 : AbstractLinkedDictionary
    {
        public LinkedHashMap2(IDictionary backend) : base(backend)
        {
        }
    ...
    public class LRUDictionary : LinkedHashMap2
    {
